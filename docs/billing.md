...
- Matching Sotto live credentials, prices, portal and signing secret are deployed. Checkout is enabled, while public signup and the mailbox-write expansion remain closed pending explicit approval to extend filtering beyond the two pilot mailboxes. No external schedule was installed.
