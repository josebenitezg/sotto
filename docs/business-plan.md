...
The launch will use the dedicated Sotto Stripe account, operated by Jose Maria Benitez Genes under the Sotto name. The founder selected this arrangement on September 11, replacing the earlier Perception Technologies Inc. setup. Products previously created in Perception are not the new launch destination. The Sotto account is activated. Public checkout remains closed until the live runtime and deployed checkout are verified. The founder chose to retain the current hosting and 15-minute Composio triggers for this release. No unlimited-processing commitment is made. The MIT software remains open source; subscriptions pay for the hosted service.
